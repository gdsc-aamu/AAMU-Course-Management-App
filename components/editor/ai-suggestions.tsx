...
import { Sparkles, Send, Bot, GraduationCap, BookOpen, AlertCircle, CheckCircle2 } from "lucide-react"
...
const QUICK_ACTIONS = [
  { label: "What courses can I take?", icon: BookOpen },
  { label: "Will I graduate on time?", icon: GraduationCap },
  { label: "Check my requirements", icon: CheckCircle2 },
]
...
function generateAIResponse(userMessage: string, currentCourses: string[]): { content: string; courses?: Course[] } {
  ...
  // Check if adding specific course affects graduation
