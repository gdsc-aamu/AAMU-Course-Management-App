...
-- ============================================================
-- DEGREEWORKS STRUCTURED DATA
-- Parsed from the student's uploaded DegreeWorks PDF.
-- Written by upsertDegreeSummary / upsertRequirementBlocks /
-- replaceBlockRequirements in backend/data-access/degree-summary.ts
-- ============================================================
